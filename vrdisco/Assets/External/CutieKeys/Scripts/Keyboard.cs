...
namespace Normal.UI {
    public class Keyboard : MonoBehaviour {
        ...
        [SerializeField]
        protected GameObject  _letters;

        [SerializeField]
        protected GameObject  _numbers;

        [SerializeField]
        protected KeyboardKey _layoutSwapKey;

        protected KeyboardMallet[] _mallets;
        ...
        protected Layout _layout = Layout.Letters;
        ...
        // Internal
        public virtual void _MalletStruckKeyboardKey(KeyboardMallet mallet, KeyboardKey key) {
        ...
        protected bool IsKeyPressedDelegateEmpty()
        {
            return keyPressed == null;
        }

        protected void InvokeKeyPressed(Keyboard keyboard, string keyPress)
        {
            keyPressed(keyboard, keyPress);
        }
    }
}
